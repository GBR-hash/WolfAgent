...
export function WerewolfChat() {
  ...
  // Use interrupt.secret_chat first; fall back to state._werewolf_secret_chat
  // (interrupt can be stale on resume; state field is the ground truth)
  ...
  return (
    <div className="bg-gradient-to-r from-red-950/20 to-red-900/10 border-2 border-red-500/40 rounded-xl p-5 mb-4 animate-pulse-glow transition-all duration-300">
      ...
      <div className="bg-night/80 rounded-lg p-3 mb-3 max-h-48 overflow-y-auto space-y-2">
        {secretChat.length === 0 && (
